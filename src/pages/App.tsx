          ...
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                ...
                <span className="block text-green-700 xl:inline pl-2">
                  Real-Time Data
                </span>
              </h1>
              <p className="text-gray-500 sm:max-w-md lg:text-xl">
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4">
                <Link
                  to="/countries"
                  className="flex items-center justify-center px-6 py-3 text-lg text-white bg-green-700 rounded-md hover:bg-green-600"
                >
                  Explore Now
                  <svg
